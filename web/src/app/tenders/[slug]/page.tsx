      ...
      <main className="flex-1 py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-xs">
              <div className="flex flex-wrap items-center gap-2 mb-4">
                <span className="text-xs font-bold text-blue-700 bg-blue-50 border border-blue-200 px-3 py-1 rounded-full">
                  {tender.source?.name || 'Source Not Recorded'}
                </span>
            ...
            {/* TENDER SUMMARY SHEETS (generated by BidHubKH from notice data) */}
            {documents.length > 0 && (
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-xs">
                <div className="flex items-center justify-between gap-4 mb-4">
                  ...
                  <span className="text-[11px] font-bold text-slate-600 bg-slate-100 border border-slate-200 px-2.5 py-0.5 rounded-full flex items-center gap-1">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-1 text-[11px] text-slate-500 font-medium">
                              ...
                              <span>•</span>
                              <span>BidHubKH Summary Sheet</span>
                            </div>
                          </div>
                        </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs space-y-6">
              ...
              <div className="pt-4 border-t border-slate-100 space-y-3">
                ...
                {tender.original_url ? (
                  ...
                  <div className="w-full flex items-center justify-center gap-2 rounded-xl bg-white border-2 border-dashed border-slate-200 text-slate-400 px-4 py-3 text-xs font-bold">
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                <span className="font-medium">AI Extraction Estimate</span>
                {typeof tender.confidence_score === 'number' ? (
                  <span className="text-slate-700 font-bold flex items-center gap-1">
                    <ShieldCheck className="h-3.5 w-3.5 text-slate-400" />
                    {tender.confidence_score}% · heuristic
                  </span>
                ) : (
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs space-y-4">
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2.5 text-xs">
                ...
                <div className="flex justify-between items-center pt-2 border-t border-slate-200">
                  ...
                  <span className="text-slate-700 font-bold flex items-center gap-1 text-[11px]">
                    <CheckCircle2 className="h-3 w-3 text-slate-400" /> Aggregated from public sources
                  </span>
                </div>
              </div>
              ...
              {documents.length > 0 && (
                <div className="space-y-2 pt-2">
                  <span className="text-[11px] font-bold text-slate-900 uppercase tracking-wider block">Summary Downloads ({documents.length})</span>
                  {documents.map((doc: any, idx: number) => {
                    const sizeMb = doc.file_size_bytes
                      ? (doc.file_size_bytes / (1024 * 1024)).toFixed(1) + ' MB'
                      : 'On demand'
                    return (
                      ...
                      >
                        <div className="truncate flex-1">
                          ...
                          <span className="text-[10px] text-slate-500 font-mono">{sizeMb} • Auto-generated PDF</span>
                        </div>
                        <a
                          href={`/api/tenders/${tender.slug}/pdf`}
                          target="_blank"
